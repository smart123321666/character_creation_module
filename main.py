...
def attack(char_name: str, char_class: str) -> str:
    ...
    Возвращает:
        str: Сообщение, указывающее результат атаки.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """
    Выполняет защиту для персонажа.
    ...
    Возвращает:
        str: Сообщение, указывающее результат защиты.
    """
    if char_class == 'warrior':
    ...
    return (f'{char_name} не смог защитился')


def special(char_name: str, char_class: str) -> str:
    """
    Применяет специальное умение для персонажа.
    ...
    Возвращает:
        str: Сообщение, указывающее результат применения специального умения.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Начинает тренировку для выбранного персонажа.
    ...
    Возвращает:
        str: Сообщение, указывающее окончание тренировки.
    """
    if char_class == 'warrior':
